...
*   eos2000, eos2002, eos2004, eos2006, eos2007, eos2009, eos10,
*     and eos11.
...
**   I M P R O V E M E N T S   O F   2 0 1 0   -   2 0 1 1 :
...
**   I M P R O V E M E N T S   O F   2 0 1 2 - 2 0 1 3 :
...
* (in the case of a mixture, this estimate is crude)
      if (LIQSOL.eq.0) then
        ...
        if (FWK.gt..7) then
         ...
         Stot=Stot+FWK*PRESSI
         PRESS=PRESS+FWK*PRESSI
         CVtot=CVtot-UWK*PRESSI
...
* When needed, the spin term must be added to the entropy externally.
      implicit double precision (A-H), double precision (O-Z)
      save
      parameter(C53=5.d0/3.d0,C76=7.d0/6.d0,
     *  TINY=1.d-20) ! prevents division by zero
...
* New quantum factor, in order to suppress CVSCR at TPT >> 1
     ...
     -             (SUPBDXG-SUPBDX*SUPBDG/SUPB)/SUPB)
      ...
      WDXG=-(Q1DX*GR3DG+Q1*(GR3DXG-2.*GR3DX*GR3DG/GR3))/GR3**2
      FSCR=-GAMI*Finf*W
